...
- **通常枠**（HARD・EXPERT・MASTER Lv.36以下）: 上位 30 譜面の合計 ÷ 30（未入力枠は 0）
- **APPEND枠**（APPEND と MASTER 37。MASTER 37 の表記は MASTER のまま）: 上位 20 譜面の合計 ÷ 20（未入力枠は 0）
- **総合レート**: `(通常枠×3 + APPEND枠×2) ÷ 5`
